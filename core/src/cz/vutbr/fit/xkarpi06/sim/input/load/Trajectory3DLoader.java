...
//        City newCity = City.defaultInstance(cityName);
        ...
        for (File directoryItem : sourceDirectory.listFiles()) {
            ...
            LOGGER.log(Level.FINEST, "Data directory contents: {0}", directoryItem.getName());
        }
    ...
    private static Vector3[] loadVertices(Map<String, File> sourceFiles) {
        ...
        if (sourceFiles.containsKey(ProjectFiles.SRC_TRAJECTORY_POLAR)) {
            ...
            LOGGER.log(Level.SEVERE, "Trajectory source is missing! Provide {0} or {1} ",
        ...
        if (sc != null) {
            ...
            LOGGER.log(Level.SEVERE, "Cannot load file {0}", sourceFile);
        }
...
//        LOGGER.log(Level.FINEST, "toCartesian {0} -> {1}", new Object[]{polar, cartesian});
        return cartesian;
    }
    ...
    private static float[] loadTimes(Map<String, File> sourceFiles) {
        return loadFloats(sourceFiles, ProjectFiles.SRC_TIMES);
    }
    ...
    private static float[] loadFloats(Map<String, File> sourceFiles, String sourceFile) {
        ...
        float[] result = new float[pitches.size()];
    ...
    private static Object parseNextLine(Scanner sc, String fileName, int lineCount) {
        ...
        try {
            ...
            if (!line.trim().isEmpty()) {
                ...
                if (result == null) {
                    LOGGER.log(Level.INFO, "Invalid line in {0}/{1}, line {2}", new Object[]{dir, fileName, lineCount});
                }
            }
