package cz.vutbr.fit.xkarpi06.sim.input.parse;

import cz.vutbr.fit.xkarpi06.sim.input.load.ProjectFiles;
import cz.vutbr.fit.xkarpi06.sim.input.parse.strategy.FloatParser;
import cz.vutbr.fit.xkarpi06.sim.input.parse.strategy.ParsingStrategy;
import cz.vutbr.fit.xkarpi06.sim.input.parse.strategy.TrajectoryParser;
